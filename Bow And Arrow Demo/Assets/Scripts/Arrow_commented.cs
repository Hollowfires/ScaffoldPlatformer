...
public class Arrow_commented : MonoBehaviour
{
    // config params
    [SerializeField] test_Crosshair crossHair1;
    ...
    private void LockArrowToCrossHair()     // locks current crosshair position for the arrow. allows the arrow
    {
